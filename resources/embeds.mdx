...
<Tip>
We recommend using our [embed builder](https://cypherbot.space/embed) instead of scripting the embeds manually as it is easier
</Tip>
...
<Info>
You can view the available variables by clicking [here](/resources/path/to/variables).
</Info>
...
<Info>
  You can view the available variables by clicking [here](/resources/placeholders).
</Info>
